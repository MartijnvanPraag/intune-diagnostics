...
- aliases: device_details, device info, device information, basic device data
...
- domain: device
- keywords: timeline, chronological, history, events, trace, investigation, device timeline
...
**Step 2: Get Compliance Status Changes Timeline**
```kusto
...
**Step 6: Get Application Install Attempts**
```kusto
